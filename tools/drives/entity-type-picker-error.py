"""entity-type-picker: the list open after the schema read was made to fail.

One state of the shot matrix. `tools/drives/upstream/entity-type-picker-error.js` drives the upstream page
...
`tools/drives/_entity_type_states.py`, shared by both pages.
    ...
    .venv/bin/python tools/qa.py --page entity-type-picker \\
        --drive tools/drives/entity-type-picker-error.py --shot shots/entity-type-picker-error.png
"""
