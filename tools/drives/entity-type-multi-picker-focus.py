"""entity-type-multi-picker: the caret holding a keyboard focus ring.

One state of the shot matrix. `tools/drives/upstream/entity-type-multi-picker-focus.js` drives the upstream page
...
`tools/drives/_entity_type_states.py`, shared by both pages.
    ...
    .venv/bin/python tools/qa.py --page entity-type-multi-picker \\
        --drive tools/drives/entity-type-multi-picker-focus.py --shot shots/entity-type-multi-picker-focus.png
"""
