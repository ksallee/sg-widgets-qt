...
//     --drive ~/dev/sg-widgets-qt/tools/drives/upstream/status-picker-loading.js --shot /tmp/ref/status-picker-loading.png
//
// The Qt half is `tools/drives/status-picker-loading.py`.
function press(el) {
