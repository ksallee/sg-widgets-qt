...
//       --drive ~/dev/sg-widgets-qt/tools/drives/upstream/user-multi-picker-filled.js --shot out.png
//
// The Qt half is `tools/drives/user-multi-picker-filled.py`.
