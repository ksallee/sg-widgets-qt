// The md date-editor with its popover open on the typed day and the month grid.
//
...
// counts and returns; the Qt half grabs its own surface as `shots/date-editor-open-popup.png`.
const row = $('[data-demo-row="md"]') ?? document;
row.scrollIntoView({ block: 'start' });
await wait(400);
const trigger = row.querySelector('[data-slot="date-editor-trigger"]');
