...
//     --drive ~/dev/sg-widgets-qt/tools/drives/upstream/status-picker-open.js --shot /tmp/ref/status-picker-open.png
//
// The Qt half is `tools/drives/status-picker-open.py`.
function press(el) {
