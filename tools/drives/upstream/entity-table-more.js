// The upstream half of `entity-table` in the `more` state, for the Qt half in
// `tools/drives/states/entity-table.py`.
//
//   pnpm qa --start --path /widgets/entity-table/ --framework react \
//     --drive tools/drives/upstream/entity-table-more.js --shot out.png
...
frame();
await wait(400);
return { verdict: 'PASS more', notes: [`loaded: ${pane().querySelector('[data-slot="entity-table-loaded"]')?.textContent.trim()}`] };
