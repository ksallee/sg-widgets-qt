...
//     --drive ~/dev/sg-widgets-qt/tools/drives/upstream/status-multi-picker-error.js --shot /tmp/ref/status-multi-picker-error.png
//
// The Qt half is `tools/drives/status-multi-picker-error.py`.
function press(el) {
