// The upstream half of `entity-table` in the `grouped` state, for the Qt half in
// `tools/drives/states/entity-table.py`.
//
//   pnpm qa --start --path /widgets/entity-table/ --framework react \
//     --drive tools/drives/upstream/entity-table-grouped.js --shot out.png
...
frame();
await wait(500);
return { verdict: 'PASS grouped', notes: [`${groupRows().length} headings`] };
