// Open the chip's hover card, then fall through to the shared measure body.
// The opening steps are `tools/drives/upstream/entity-chip-preview-open.js`, with its verdict
// dropped so the measurement below is what the drive answers.
function hoverOn(el) {
