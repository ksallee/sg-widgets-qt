// Measured: entity-tree. Built by `_build.py`; edit the parts, not this file.
...
async function openIt() {
  const el = await until(() => $$('[data-slot="entity-tree-chevron"]', pane).find((e) => e.getClientRects().length > 0), 15000);
  if (!el) return;
