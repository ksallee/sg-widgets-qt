// Measured: field-editor. Built by `_build.py`; edit the parts, not this file.
...
async function openIt() {
  const el = await until(() => $$('[data-slot="field-editor-display"]', pane).find((e) => e.getClientRects().length > 0), 15000);
  if (!el) return;
