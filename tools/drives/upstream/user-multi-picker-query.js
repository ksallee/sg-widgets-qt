...
//       --drive ~/dev/sg-widgets-qt/tools/drives/upstream/user-multi-picker-query.js --shot out.png
//
// The Qt half is `tools/drives/user-multi-picker-query.py`.
...
if (!input) return { verdict: 'FAIL no query input in the multi case' };
bring(box);
await wait(400);
openControl(box);
