...
//     --drive ~/dev/sg-widgets-qt/tools/drives/upstream/status-picker-focus.js --shot /tmp/ref/status-picker-focus.png
//
// The Qt half is `tools/drives/status-picker-focus.py`.
function press(el) {
