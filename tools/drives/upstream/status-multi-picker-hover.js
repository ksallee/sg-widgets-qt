...
//     --drive ~/dev/sg-widgets-qt/tools/drives/upstream/status-multi-picker-hover.js --shot /tmp/ref/status-multi-picker-hover.png
//
// The Qt half is `tools/drives/status-multi-picker-hover.py`.
function press(el) {
