// entity-type-multi-picker: the `focus` state of the shot matrix.
//
//   node tools/qa.mjs --base http://127.0.0.1:4466 --path /widgets/entity-type-multi-picker/ --framework react \
//     --drive ~/dev/sg-widgets-qt/tools/drives/upstream/entity-type-multi-picker-focus.js --shot /tmp/ref/entity-type-multi-picker-focus.png
function press(el) {
