...
what the QA pass reads.
    ...
    .venv/bin/python tools/qa.py --page field-picker --drive tools/drives/field-picker-open.py \
        --shot shots/states/field-picker-open.png
"""
...
from _wave_states import field_picker_open  # noqa: E402


def drive(page, wait, find, prefs) -> dict:
    return field_picker_open(page, wait, find, prefs)
